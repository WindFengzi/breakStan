...
public class MainReformViewActivity extends BaseActivity {
	...
	private OnItemClickListener listListener = new OnItemClickListener() {
		public void onItemClick(AdapterView<?> parent, View view, int position,
			...
			Intent intent = new Intent(view.getContext(),
					ReformViewModifyActivity.class);
			...
			startActivityForResult(intent, UIHelper.INTENT_VIEW_REFORM_MODIFY);
	...
	protected void reLoadView() throws Exception {
		...
		rtnValue = appContext.getBreakRefromView();
