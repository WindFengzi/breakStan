...
public class MainBreakViewActivity extends BaseActivity {
	...
	private OnItemClickListener listListener = new OnItemClickListener() {
		public void onItemClick(AdapterView<?> parent, View view, int position,
			...
			Intent intent = new Intent(view.getContext(), BreakViewModifyActivity.class);
			intent.putExtra("break_rule_id", tv.getText().toString());
			intent.putExtra("break_rule_content", tvContent.getText().toString());
			
			
			intent.putExtra("org_name", txOrgName.getText().toString());
			//intent.putExtra("break_type_name", appContext.getBreakRuleType(Integer.valueOf(tv.getText().toString())));
			
		
			startActivityForResult(intent, UIHelper.INTENT_VIEW_BREAK_MODITY);
	...
	protected void reLoadView() throws Exception {
		...
		rtnValue = appContext.getBreakViewView();
