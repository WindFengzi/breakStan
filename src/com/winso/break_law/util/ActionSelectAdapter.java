...
public class ActionSelectAdapter extends BaseAdapter {    
    ...
    public ActionSelectAdapter(Context context) {    
...
//        }    
    ...
    public void updateData(SelectHelp help)
    {
        ...
        for (int i = 0; i < help.size(); i++) {    
            Map<String, Object> map = new HashMap<String, Object>();    
            //map.put("img", R.drawable.icon);    
            map.put("detail_id", help.valueStringByName(i, "detail_id"));  
            map.put("list_item_title", help.valueStringByName(i, "content") );    
            mData.add(map);    
        }    
        //这儿定义isSelected这个map是记录每个listitem的状态，初始状态全部为false。    
        isSelected = new HashMap<Integer, Boolean>();    
